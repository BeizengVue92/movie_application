...
public class MovieDaoImpl implements MovieDao{
    ...
    public void populate(String filePath) throws MovieDaoException {
        ...
        try {
            ...
            final List<Movie> film = WorkbookUtility.retrieveMovieFromWorkBook(inputFile);
    ...
    public List<Movie> retrieveMovie() throws MovieDaoException {
        ...
        final List<Movie> film = new ArrayList<Movie>();
        ...
        try {
            ...
            e.printStackTrace();
            throw new MovieDaoException("Error: Unable to retrieve list of movie");
        }
